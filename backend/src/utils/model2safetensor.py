...
sys.path.append('Image-talking/my_env')
...
size = 256
############ face vid2vid
config_path =  os.path.join('..', 'config', 'facerender.yaml')
current_root_path = '.'
...
save_file(model.state_dict(), "../../checkpoints/doyenTalkerV0.0.2_"+str(size)+".safetensors")

### test
load_cpk_facevid2vid_safetensor('doyenTalker_V0.0.2_'+str(size)+'.safetensors', kp_detector=kp_extractor, generator=generator, he_estimator=None)